...
public class DumpedPrivateKey extends PrefixedChecksummedBytes {
     ...
     */
    public static DumpedPrivateKey fromBase58(NetworkParameters params, String base58)
        ...
        if (params == null) {
            ...
            throw new Exception(".InvalidPrefix No network found for version " + version);
        } else {
            if (version == params.getDumpedPrivateKeyHeader())
                return new DumpedPrivateKey(params, bytes);
            throw new Exception("WrongNetwork "+ version);
        }
    }
